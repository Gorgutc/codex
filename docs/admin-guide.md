...
Подсказка: счётчики «8 assets» на карточках категорий сайта — это обычные
строки из раздела «Тексты интерфейса» (группа «Free Assets — теги»).
Если вы скрыли часть ассетов, поправьте счётчики там же.
