/* ═══════════════════════════════════════════════════════════════════════
   ...
   Все free-assets карточки теперь имеют GLB preview. Для карточек без SVG
   thumb остаётся null, а model-path берётся из './assets/models/free/' + id + '.glb'.
   Когда подъедут финальные production preview'ы — положить SVG/GLB с именем id или
...
var FA_DATA = {
  'hard-surface': [
    ...
    { id:'bolt-cluster',   thumb:null, cat:'Hard Surface', title:'Bolt Cluster',     desc:'Industrial fastener kit — 12 variants. Scatter-ready GeoNodes setup.',       badge:'Hard Surface', contents:['.blend','12 variants','GeoNodes setup','2K textures'],                      size:'31 MB',  file:'bolt-cluster.zip',   bg:'linear-gradient(135deg,#1e2428 0,#2a3038 100%)' },
    { id:'terra-base',     thumb:null, cat:'Hard Surface', title:'Terra Base',       desc:'Modular environment kit — 24 tileable pieces. GeoNodes scatter system.',     badge:'Hard Surface', contents:['.blend','24 modules','GeoNodes','4K tileable textures'],                    size:'182 MB', file:'terra-base.zip',     bg:'linear-gradient(135deg,#1c2030 0,#28303e 100%)' },
    { id:'shard-cannon',   thumb:null, cat:'Hard Surface', title:'Shard Cannon',     desc:'Sci-fi heavy weapon — three skin variations, UE5-compatible export.',        badge:'Hard Surface', contents:['.fbx','.blend','3 skin variants','4K PBR'],                                size:'103 MB', file:'shard-cannon.zip',   bg:'linear-gradient(135deg,#1a1a2a 0,#252535 100%)' },
    { id:'wraith-blade',   thumb:null, cat:'Hard Surface', title:'Wraith Blade',     desc:'Thin melee weapon with emissive edge glow texture variant included.',        badge:'Hard Surface', contents:['.fbx','.blend','Emissive variant','4K PBR'],                               size:'76 MB',  file:'wraith-blade.zip',   bg:'linear-gradient(135deg,#1e1a28 0,#2a2438 100%)' },
  ...
  'product': [
    ...
    { id:'echo-shell',     thumb:null, cat:'Product Viz',  title:'Echo Shell',       desc:'Speaker product scene — three colorways, compositing nodes included.',      badge:'Product Viz',  contents:['.blend','3 colorways','Compositor','4K renders'],                          size:'118 MB', file:'echo-shell.zip',     bg:'linear-gradient(135deg,#1e2024 0,#282830 100%)' },
    { id:'prism-lab',      thumb:null, cat:'Product Viz',  title:'Prism Lab',        desc:'Architectural product viz — day and night lighting setups.',                badge:'Product Viz',  contents:['.blend','Day lighting','Night lighting','4K renders'],                     size:'145 MB', file:'prism-lab.zip',      bg:'linear-gradient(135deg,#1c2030 0,#282a40 100%)' },
  ],
  'game': [
    ...
    { id:'wraith-blade-g', thumb:null, cat:'Game Asset',   title:'Wraith Blade',     desc:'Thin melee weapon. High-poly bake, emissive edge glow variant.',            badge:'Game Asset',   contents:['.fbx','.blend','Emissive variant','4K PBR'],                               size:'76 MB',  file:'wraith-blade.zip',   bg:'linear-gradient(135deg,#1e1a28 0,#2a2438 100%)' },
    { id:'shard-cannon-g', thumb:null, cat:'Game Asset',   title:'Shard Cannon',     desc:'Sci-fi heavy weapon — three skin variations, UE5-compatible.',              badge:'Game Asset',   contents:['.fbx','.blend','3 skin variants','4K PBR'],                               size:'103 MB', file:'shard-cannon.zip',   bg:'linear-gradient(135deg,#1a1a2a 0,#252535 100%)' },
  ],
  'organic': [
