...
- Assets: `.agents/skills/codex-studio-assets/SKILL.md`,
  `scripts/asset-budget.mjs`, and `docs/agent/verification.md`
...
- For asset additions or reference changes, run `npm run check:assets` and the
  applicable `npm run verify` runtime gate; a passing byte check does not prove
  3D readiness.
